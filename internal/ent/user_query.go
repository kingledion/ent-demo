...
func (uq *UserQuery) QueryOrder() *MerchantQuery {
	query := &MerchantQuery{config: uq.config}
...
func (uq *UserQuery) WithOrder(opts ...func(*MerchantQuery)) *UserQuery {
	query := &MerchantQuery{config: uq.config}
	...
	if query := uq.withOrder; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(user.OrderPrimaryKey[0], fks...))
			},
		...
		query.Where(merchant.IDIn(edgeids...))
